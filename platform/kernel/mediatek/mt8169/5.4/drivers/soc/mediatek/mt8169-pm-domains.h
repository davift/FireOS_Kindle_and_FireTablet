...
static const struct scpsys_domain_data scpsys_domain_data_mt8169[] = {
	...
	[MT8169_POWER_DOMAIN_IMG2] = {
		...
		.reset_smi = {
			SMI_RESET_WR(MT8169_SMI_LARB11_RESET_STEP1,
				MT8169_SMI_LARB11_RESET_ADDR_STEP1),
			SMI_RESET_WR(MT8169_SMI_LARB11_RESET_STEP2,
				MT8169_SMI_LARB11_RESET_ADDR_STEP2),
		},
