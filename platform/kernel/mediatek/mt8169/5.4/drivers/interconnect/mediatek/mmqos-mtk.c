...
/*HRT high loading threshold,use hrt bandwidth as recoup to QoS path,1600 = 6400 * 25%*/
#define HRT_RECOUP_THRESHOLD	  (1600000)
...
#if IS_ENABLED(CONFIG_MMQOS_HRT_RECOUP)
	if (peak_bw > HRT_RECOUP_THRESHOLD)
