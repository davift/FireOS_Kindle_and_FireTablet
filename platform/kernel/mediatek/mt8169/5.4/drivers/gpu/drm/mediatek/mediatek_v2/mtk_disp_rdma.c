...
static void mtk_disp_dump_info_for_underflow(struct mtk_disp_rdma *priv)
{
	...
	DDPMSG("WPE SMI info dump 0x400=0x%x,0x404=0x%x,0x430=0x%x\n",
		readl(priv->regs[WPE_SMI_SUB_COMMON] + 0x400),
		readl(priv->regs[WPE_SMI_SUB_COMMON] + 0x404),
		readl(priv->regs[WPE_SMI_SUB_COMMON] + 0x430));
	DDPMSG("SMI info dump common 0x400=0x%x,0x404=0x%x,0x408=0x%x,0x40C=0x%x,0x410=0x%x\n",
		readl(priv->regs[DISP_SMI_COMMON] + 0x400),
		readl(priv->regs[DISP_SMI_COMMON] + 0x404),
		readl(priv->regs[DISP_SMI_COMMON] + 0x408),
		readl(priv->regs[DISP_SMI_COMMON] + 0x40C),
		readl(priv->regs[DISP_SMI_COMMON] + 0x410));
	DDPMSG("SMI info dump common 0x414=0x%x,0x418=0x%x,0x41C=0x%x,0x430=0x%x,0x434=0x%x\n",
		readl(priv->regs[DISP_SMI_COMMON] + 0x414),
		readl(priv->regs[DISP_SMI_COMMON] + 0x418),
		readl(priv->regs[DISP_SMI_COMMON] + 0x41C),
		readl(priv->regs[DISP_SMI_COMMON] + 0x430),
		readl(priv->regs[DISP_SMI_COMMON] + 0x434));
	...
	DDPMSG("SMI info dump larb1 0x288=0x%x\n",
		readl(priv->regs[LARB1_REG_BASE] + 0x288));
	DDPMSG("ovl0 info dump 0x020=0x%x,0x02C=0x%x,0x038=0x%x,0x058=0x%x\n",
	...
	DDPMSG("ovl0 info dump 0x078=0x%x,0x098=0x%x,0x240=0x%x,0x244=0x%x\n",
		readl(priv->regs[OVL0_REG_BASE] + 0x078),
		readl(priv->regs[OVL0_REG_BASE] + 0x098),
		readl(priv->regs[OVL0_REG_BASE] + 0x240),
			      ...
			      void *data)
{
	...
	if (IS_ERR(priv->ddp_comp.qos_req)) {
		DDPPR_ERR("%s get invalid qos_req path!\n", __func__);
		priv->ddp_comp.qos_req = NULL;
	}
	...
	if (IS_ERR(priv->ddp_comp.hrt_qos_req)) {
		DDPPR_ERR("%s get invalid hrt_qos_req path!\n", __func__);
		priv->ddp_comp.hrt_qos_req = NULL;
	}
#endif
...
static void mtk_disp_rdma_get_dump_module_regs(struct mtk_disp_rdma *priv)
{
	...
	priv->regs[DISP_SMI_COMMON] = ioremap(0x14002000, 0x4);
	priv->regs[WPE_SMI_SUB_COMMON] = ioremap(0x1401D000, 0x4);
}
