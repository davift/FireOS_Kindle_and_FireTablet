 ...
 * @KREE_MEM_SEC_CM_CMA: dynamic chunk memory carved out from CMA for WFD (old).
 * @KREE_MEM_SEC_CM_CMA_WFD: dynamic chunk memory carved out from CMA for WFD (new).
 * @KREE_MEM_SEC_CM_CMA_SVP: dynamic chunk memory carved out from CMA for SVP.
 * @KREE_MEM_SEC_CM_CMA_DISP: dynamic chunk memory carved out from CMA for display.
 */
enum kree_mem_type {
	...
	KREE_MEM_SEC_CM_TZ,
	KREE_MEM_SEC_CM_CMA,
	/* extensive secure memory */
	KREE_MEM_SEC_MEM_SVP		= 0x10,
	/* extensive chunk memory with static block */
	KREE_MEM_SEC_CM_TZ_SVP		= 0x20,
	/* extensive chunk memory with cma */
	KREE_MEM_SEC_CM_CMA_SVP		= 0x40,
	KREE_MEM_SEC_CM_CMA_WFD		= 0x41,
	KREE_MEM_SEC_CM_CMA_DISP	= 0x42,
};
#endif

#if IS_ENABLED(CONFIG_MTEE_CMA_SECURE_MEMORY)
struct mtee_cma_sec_mem {
	struct cma *tz_cma;
